  ...
  <div class="video-wrapper">
    <el-container class="video-layout-wrapper">
      ...
      <el-container class="video-content-wrapper">
        ...
        <el-main
          v-if="this.currentVideoList.length == 1"
          class="video-main-wrapper video-main-wrapper1"
        >
          <BaseVideo
            :ref="item.cameraId"
            class="video-item"
        ...
        <el-main v-else class="video-main-wrapper video-main-wrapper9">
          <BaseVideo
            :ref="item.cameraId"
            class="video-item"
            :class="item.cameraId"
...
export default {
  ...
  methods: {
    ...
    initVideo() {
      this.vDataList = [];
      this.currentVideoList.forEach((item, index) => {
        this.vDataList.push({
    ...
    handleNodeClick(a, b, c) {
      ...
      switch (a.label) {
        case "右前视角":
          this.currentVideoList = [this.videoList[0]];
          break;
        case "正前视角":
          this.currentVideoList = [this.videoList[1]];
          break;
        case "右后视角":
          this.currentVideoList = [this.videoList[2]];
          break;
        default:
          break;
      }
